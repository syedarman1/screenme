                ...
                <div className="flex items-center gap-2">
                  ...
                  {userId && !saved && !showSaveInput && (
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-accent text-accent-fg hover:bg-accent-hover transition-colors cursor-pointer"
                    >
              ...
              {showSaveInput && (
                <div className="flex items-center gap-2 px-6 py-3 border-b border-border bg-surface-2">
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="px-4 py-2 rounded-lg bg-accent text-accent-fg text-xs font-semibold hover:bg-accent-hover disabled:opacity-50 transition-colors cursor-pointer"
                  >
                    {saving ? "Saving…" : "Save"}
                  </button>
                  <button
